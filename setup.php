...
#define('__CA_LOG_DATABASE_QUERIES__', true);
#define('__CA_SHOW_FULL_STACKTRACE_IN_DATABASE_QUERY_LOG__', true);
#
...
if (!defined("__CA_APP_DISPLAY_NAME__")) {
	define("__CA_APP_DISPLAY_NAME__", "AMNH Anthropology Collection");
}
...
if (!defined("__CA_ADMIN_EMAIL__")) {
	define("__CA_ADMIN_EMAIL__", 'landua@amnh.org');
}
...
define("__CA_SMTP_SERVER__", 'mail-smtp-vip.amnh.org');
...
# __CA_GOOGLE_RECAPTCHA_KEY__ + __CA_GOOGLE_RECAPTCHA_SECRET_KEY__ = A Google Recaptcha key pair for use on contact form (optional)
#
if (!defined("__CA_GOOGLE_RECAPTCHA_KEY__")) {
	 define("__CA_GOOGLE_RECAPTCHA_KEY__", "6LfSI-IpAAAAAMNSH98PmHKmC8vB8MYGbifBQPHk");
}
if (!defined("__CA_GOOGLE_RECAPTCHA_SECRET_KEY__")) {
	 define("__CA_GOOGLE_RECAPTCHA_SECRET_KEY__", "6LfSI-IpAAAAAEsIdOlHblD07xC7Qlbgg0XtFHMp");
}
...
$_CA_THEMES_BY_DEVICE = [
	'_default_' 	=> 'amnhAnthro'		// use the 'default' theme for everything else
];
